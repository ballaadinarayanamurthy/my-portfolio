    ...
    <div className="min-h-screen bg-white text-black p-6 sm:p-12 max-w-4xl mx-auto font-sans leading-relaxed">
      ...
      <div className="mt-6 space-y-2">
        ...
        <p className="text-xs text-gray-800 leading-relaxed text-justify">
          Experienced Civil Construction Manager with over 30 years of expertise in executing large-scale industrial, infrastructure, commercial and EPC projects. Specialized in pile foundations, pile cap construction, deep excavation, geo-grid works, RCC structures, steel structure erection, MEP coordination, and slab construction of high-rise buildings. Proven ability in project planning, execution, manpower management, contractor coordination, quality control, safety compliance, and timely project delivery.
        </p>
        <p className="text-xs text-gray-800 leading-relaxed text-justify">
          Strong knowledge of construction methodologies, project scheduling, QA/QC procedures, structural drawings, BOQ management, and site administration. Experienced in handling multidisciplinary teams and coordinating with consultants, clients, vendors, and subcontractors.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-2">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-xs text-gray-800">
          <div>&bull; Pile Foundation Works</div>
          <div>&bull; Pile Cap &amp; Raft Foundations</div>
          <div>&bull; Geo-grid &amp; Soil Stabilization</div>
          <div>&bull; RCC Structures &amp; Slab Casting</div>
          <div>&bull; Structural Steel Erection</div>
          <div>&bull; Pre-engineered Buildings (PEB)</div>
          <div>&bull; High rise buildings</div>
          <div>&bull; Industrial &amp; Infrastructure Projects</div>
          <div>&bull; MEP Coordination</div>
          <div>&bull; Project Planning &amp; Scheduling</div>
          <div>&bull; Site Execution &amp; Supervision</div>
          <div>&bull; Quality Assurance / QA-QC</div>
          <div>&bull; Quantity Estimation &amp; BOQ</div>
          <div>&bull; Contractor &amp; Vendor Management</div>
          <div>&bull; HSE &amp; Safety Management</div>
          <div>&bull; Team Leadership</div>
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <ul className="list-disc list-outside pl-4 text-xs text-gray-800 space-y-1 pt-1">
            <li>Managed complete civil construction activities for industrial and infrastructure projects from excavation to commissioning.</li>
            <li>Supervised major pile foundation works, pile caps, raft foundations, pedestals including bored cast-in-situ piles, pile integrity tests, and load testing for gated community high raised apartments at Rajahmundry.</li>
            ...
            <li>Coordinated with MEP teams for embedded conduits, sleeves, trenches, cable routing, and equipment foundations.</li>
            ...
            <li>Ensured compliance with QA/QC standards, approved drawings, and HSE requirements.</li>
          </ul>
        </div>
        ...
        <div className="space-y-1 pt-2">
          ...
          <ul className="list-disc list-outside pl-4 text-xs text-gray-800 space-y-1 pt-1">
            <li>Managed construction and QA/QC activities for major oil and gas projects.</li>
            <li>Supervised construction crews and subcontractors.</li>
        ...
        <div className="space-y-1 pt-2">
          <div className="flex justify-between items-baseline font-bold text-xs">
            <span>Construction Manager &ndash; Saudi Aramco Projects, KSA</span>
          ...
          <ul className="list-disc list-outside pl-4 text-xs text-gray-800 space-y-1 pt-1">
            ...
            <li>Executed construction of high rise building at Hadeed (SABIC plant) at KSA.</li>
            <li>Executed erection of Steel structures including columns, beams, braces and roof structures for different Saudi Aramco Projects.</li>
            <li>Coordinated with clients, contractors, and engineering teams.</li>
        ...
        <div className="space-y-1 pt-2">
          ...
          <ul className="list-disc list-outside pl-4 text-xs text-gray-800 space-y-1 pt-1">
            <li>Implemented QA/QC procedures, QC plans, and work instructions.</li>
            <li>Prepared inspection test plans and method statements.</li>
            <li>Conducted site inspections and material inspections.</li>
      ...
      <div className="mt-6 space-y-2">
        ...
        <ul className="list-disc list-outside pl-4 text-xs text-gray-800 space-y-1">
          ...
          <li>Hadeed Steel Plant Expansion &ndash; SABIC</li>
